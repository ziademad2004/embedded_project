...
// Register enums with Qt's meta-object system for QVariant support
Q_DECLARE_METATYPE(GameLogic::GameResult)
Q_DECLARE_METATYPE(GameLogic::Player)
Q_DECLARE_METATYPE(GameLogic::AIDifficulty)
...
void TestGameLogic::initTestCase()
{
    ...
    // Register metatypes at runtime
    qRegisterMetaType<GameLogic::GameResult>("GameLogic::GameResult");
    qRegisterMetaType<GameLogic::Player>("GameLogic::Player");
    qRegisterMetaType<GameLogic::AIDifficulty>("GameLogic::AIDifficulty");
}
