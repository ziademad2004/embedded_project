...
int AIOpponent::findBestMove(QVector<Player>& board, int maxDepth) {
    ...
    // 3. For easy/medium, sometimes random
    if (m_gameLogic->getAIDifficulty() == GameLogic::AIDifficulty::Easy && QRandomGenerator::global()->bounded(100) < 30) {
